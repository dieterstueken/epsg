...
public class ExtractAllCoordinateReferenceSystemDemo {
    ...
    public static void main(String[] args) throws FactoryException, FileNotFoundException, IOException {
        ...
        final AuthorityFactory factory = AuthorityFactoryFinder.getAuthorityFactory();
    ...
    private static Map<String,String> toWKTMap(final AuthorityFactory factory, final Collection<String> codes){
