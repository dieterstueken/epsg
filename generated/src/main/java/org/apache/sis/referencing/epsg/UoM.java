...
public class UoM<Q extends Quantity<Q>> extends Aliased {
    ...
    public static final UoM<Length> U_9002 = uom(9002, FOOT_INTERNATIONAL, "foot");
    public static final UoM<Length> U_9003 = uom(9003, FOOT_US_SURVEY, "US survey foot", "Used in USA.");
    public static final UoM<Length> U_9005 = uom(9005, METER.multiply(0.3047972654), "Clarke's foot", "Assumes Clarke's 1865 ratio of 1 British foot = 0.3047972654 French legal metres applies to the international metre.   Used in older Australian, southern African & British West Indian mapping.");
